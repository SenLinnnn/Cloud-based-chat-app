...
public class ChatProvider extends ContentProvider {
    ...
    public static class DbHelper extends SQLiteOpenHelper {
        ...
        private static final String DATABASE_CREATE1 = "create table " + PEERS_TABLE + " ("
        ...
        private static final String DATABASE_CREATE2 = "create table " + MESSAGES_TABLE + " ("
                ...
                + LATITUDE + " text,"
                + LONGITUDE + " text,"
                + PEER_FK + " integer, foreign key (" + PEER_FK + ") references "
                + PEERS_TABLE + "(" + PEER_ID + ") on delete cascade);";
